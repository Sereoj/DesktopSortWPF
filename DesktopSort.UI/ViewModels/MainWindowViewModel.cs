...
namespace DesktopSort.UI.ViewModels
{
    public class MainWindowViewModel : ViewModel
    {
        ...
        {
            var model = sender as SettingsWindowViewModel;
        ...
        public ICommand MinimalizeApplicationCommand => _MinimalizeApplicationCommand ??=
            _MinimalizeApplicationCommand = new RelayCommand(OnMinimalizeApplicationCommandExecuted,
