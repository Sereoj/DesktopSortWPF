    ...
    public class SettingsModel
    {
        ...
        public void Default()
        {
            var item = new SettingsModel
            {
                ...
                {
                    new BasicConfig
                        {ID = "1", IsChecked = false, Catalog = "Word", Extension = ".docx,.dotx,.doc,.dot"},
                    new BasicConfig
                    {
                        ID = "2", IsChecked = false, Catalog = "Excel",
                    ...
                    new BasicConfig
                        {ID = "8", IsChecked = false, Catalog = "Image", Extension = ".bmp,.tif,.jpg,.gif,.png,.ico"},
                    new BasicConfig
                        {ID = "9", IsChecked = false, Catalog = "Media", Extension = ".avi,.mp4,.mpeg,.wmv,.mp3"},
                    new BasicConfig {ID = "10", IsChecked = false, Catalog = "Archive", Extension = ".rar,.zip,.7z"},
                    new BasicConfig
                        {ID = "11", IsChecked = false, Catalog = "eBook", Extension = ".fb2,.epub,.mobi,.pdf,.djvu"},
